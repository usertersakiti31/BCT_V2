#!/usr/bin/python
#######################################
#  Scrip Creator By ./WhiteSystem404  #
#######################################
mess = """======================================================
             Deface Script Creator        
           [+] Banyumas Cyber Team [+]
          Fungsi : untuk membuat Scrip Deface
======================================================"""

print mess
print "Created by team Banyumas Cyber Team"
...
textcolor = raw_input("Warna text (contoh=yellow): ")
...
print "Kontak : dedidarmadi745@gmail.com"
